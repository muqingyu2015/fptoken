...
public final class FpTokenBlockLevelPolicy {
	...
	public final static int HASH_MAP_DEFAULT_SIZE=HASH_MAP_TOKEN_SIZE*64;
	 ...
	 * <p>
	 * 词项上级别大于等于该目标时，由 {@link cn.lxdb.plugins.muqingyu.fptoken.api.FpTokenBlockOrchestrator} 走透传/高候选路径，不参与低级别合并链。
	 *
